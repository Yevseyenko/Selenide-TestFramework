...
import com.epam.core2.client.RestApacheClient;
...
//        InterfaceClient client = ClientResolver.getClient("");
...
//    }
//
//    @Test(priority = 1, description = "Verifying status code scenario", dataProvider = "jsonDataProvider", dataProviderClass = UserDataProvider.class)
...
//        String response = client.getUserByFirstNameResponse(user.getFirst_name());
        RestApacheClient client = new RestApacheClient();
        String response = client.getUserByFirstNameResponse(user.getFirst_name().toString());
        System.out.println("***"+user.getFirst_name()+"***");
        System.out.println("***"+BusinessLogic.getFromResponseUserFirstName(response).get(0)+"***");
        System.out.println(BusinessLogic.getFromResponseUserFirstName(response).get(0).equals(user.getFirst_name()));
