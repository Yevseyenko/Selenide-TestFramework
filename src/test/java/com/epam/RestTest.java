...
public class RestTest {
    ...
    @Test(priority = 2, description = "Verifying status code scenario")
    ...
    public void getUsersByLastNameTest(User user) {
        ...
        String response = client.getUserByFirstNameResponse(user.getFirst_name());
        Assert.assertTrue(BusinessLogic.getFromResponseUserLastName(response).contains(user.getLast_name()), "Request failed ");
    }
